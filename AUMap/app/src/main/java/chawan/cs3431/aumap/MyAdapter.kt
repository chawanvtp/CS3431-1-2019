...
import kotlinx.android.synthetic.main.faculty_row.view.*
import java.util.*

class MyAdapter(val items: ArrayList<Faculty>, val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    var baseURL = "http://www.majorcineplex.com"

    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): RecyclerView.ViewHolder {
        return ViewHolder(LayoutInflater.from(context).inflate(R.layout.faculty_row, p0, false))
    }
    ...
    override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
        ...
        parent?.getNameTv?.text = "${items[p1].FacultyName} (${items[p1].FacultyName.})"

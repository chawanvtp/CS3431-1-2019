package chawan.cs3431.oceanlife
...
import kotlinx.android.synthetic.main.detail_main.imageView
import kotlinx.android.synthetic.main.detail_main.imageView2
import kotlinx.android.synthetic.main.detail_main.imageView3
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[1].title)
            intent.putExtra("th",lifeList[1].th)
            intent.putExtra("en",lifeList[1].en)
            intent.putExtra("image",myImageList[1])
        ...
        imageView2.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[5].title)
            intent.putExtra("th",lifeList[5].th)
            intent.putExtra("en",lifeList[5].en)
            intent.putExtra("image",myImageList[5])
        ...
        imageView3.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[0].title)
            intent.putExtra("th",lifeList[0].th)
            intent.putExtra("en",lifeList[0].en)
            intent.putExtra("image",myImageList[0])
        ...
        imageView4.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[2].title)
            intent.putExtra("th",lifeList[2].th)
            intent.putExtra("en",lifeList[2].en)
            intent.putExtra("image",myImageList[2])
        ...
        imageView5.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[3].title)
            intent.putExtra("th",lifeList[3].th)
            intent.putExtra("en",lifeList[3].en)
            intent.putExtra("image",myImageList[3])
        ...
        imageView6.setOnClickListener {
            ...
            intent.putExtra("title",lifeList[4].title)
            intent.putExtra("th",lifeList[4].th)
            intent.putExtra("en",lifeList[4].en)
            intent.putExtra("image",myImageList[4])
